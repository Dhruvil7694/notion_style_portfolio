...
import { BookOpen, Briefcase, Building2, CircleUser, Layers, Sparkles } from "lucide-react"
...
export const DOCK_NAV_ITEMS: DockNavItem[] = [
  ...
  { label: "Projects", sectionId: "projects", href: "/projects", icon: Briefcase },
  { label: "Tech Stack", sectionId: "tech-stack", href: "/stack", icon: Layers },
  { label: "AI First", sectionId: "ai-first", href: "/ai-first", icon: Sparkles },
  { label: "Knowledge", sectionId: "knowledge", href: "/research", icon: BookOpen },
  { label: "Experience", sectionId: "experience", href: "/experience", icon: Building2 },
]
...
export function resolveMobileNavHref(item: MobileNavItem, isHome: boolean): string {
