...
import { extractEntitiesFromContent, extractEntitiesFromProject } from "@/lib/knowledge/entity-extractor"
import { generateCanonicalUrl, resolveSiteUrl } from "@/lib/seo/canonical"
import type { Content, Project } from "@/types/database.helpers"

export type SearchDocumentType = "project" | "research" | "writing" | "automation"
...
export async function buildSearchIndex(
  ...
  const projectDocuments = projects.map((project) => projectToSearchDocument(project, siteUrl))
