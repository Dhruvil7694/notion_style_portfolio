...
import { aiProviderIdSchema, aiSettingsSchema } from "@/lib/ai/settings"
...
export function toAiSettingsFormValues(settings: z.infer<typeof aiSettingsSchema>): AiSettingsFormValues {
  return {
