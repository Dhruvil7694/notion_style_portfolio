...
export function toProfileFormValues(site: z.infer<typeof siteSettingsSchema>): ProfileFormValues {
  return {
...
export function toAboutFormValues(settings: {
  ...
  return {
    ...
    intro_tools: settings.about.intro_tools ?? DEFAULT_ABOUT_CONTENT.intro_tools,
    career_intro: settings.about.career_intro ?? DEFAULT_ABOUT_CONTENT.career_intro,
    after_umbrella: settings.about.after_umbrella ?? DEFAULT_ABOUT_CONTENT.after_umbrella,
