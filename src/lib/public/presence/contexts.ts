import type { ContactInfo, SiteSettings } from "@/lib/public/settings"
import {
  getISTDay,
  getISTHour,
  getISTMinute,
} from "@/lib/public/workspace-utils"
...
export function buildWorkspaceContext(input: WorkspaceContextInput): WorkspaceContext {
  ...
  return {
    ...
    customStatus: trimOrUndefined(input.site.custom_status ?? input.site.status_bubble),
