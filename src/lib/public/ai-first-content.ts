...
export const AI_FIRST_USE_CASES: AiFirstUseCase[] = [
  {
    ...
    tools: [
      ...
      },
      {
        ...
        role: "Tool layer",
        icon: "simple-icons:modelcontextprotocol",
        description: "Expose search, calendar, and CRM actions to the agent safely.",
      },
      {
      ...
      },
      {
        ...
        role: "Context",
        icon: "simple-icons:supabase",
        description: "Ground drafts in past threads, playbooks, and product docs.",
      },
    ],
  },
  {
    ...
    keywords: ["research automation", "RAG pipeline", "citations", "knowledge synthesis"],
    tools: [
      {
        name: "Custom ingestion pipeline",
        role: "ETL",
        icon: "lucide:workflow",
        description: "Normalize PDFs, URLs, and notes into a searchable corpus.",
      },
      {
      ...
      },
      {
        ...
        role: "Reasoning",
        icon: "lucide:sparkles",
        description: "Separate summarize, compare, and critique steps for quality.",
      },
    ],
  },
  {
    ...
    tools: [
      {
        ...
        role: "Implementation",
        icon: "simple-icons:cursor",
        description: "Scoped edits with project conventions baked into prompts.",
      },
      {
        name: "GitHub MCP",
        role: "Delivery",
        icon: "simple-icons:github",
        description: "Open PRs, attach summaries, and link issues automatically.",
      },
      {
        name: "Eval harness",
        role: "Quality",
        icon: "lucide:clipboard-check",
        description: "Regression checks on prompts and tool calls before deploy.",
      },
    ],
  },
  {
    ...
    keywords: ["support automation", "copilot", "ticket routing", "GEO/AEO content"],
    tools: [
      {
        name: "Helpdesk API",
        role: "Channel",
        icon: "simple-icons:zendesk",
        description: "Create drafts, tags, and escalations in the existing stack.",
      },
      {
        name: "Structured output schemas",
        role: "Safety",
        icon: "lucide:braces",
        description: "Force category, confidence, and citation fields on every reply.",
      },
      {
