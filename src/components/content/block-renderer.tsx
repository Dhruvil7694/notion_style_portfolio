...
import { ExpandableBlock } from "@/components/content/blocks/expandable-block"
...
function renderBlock(
  ...
  switch (block.type) {
    ...
    case "callout":
      return (
        <CalloutBlock content={block.content} key={index} variant={block.variant} />
      )
    ...
    default:
      return (
        <p className="text-muted-foreground text-sm italic" key={index} role="note">
