...
import type { InlineSpan, RichText } from "@/lib/content/inline"
import { normalizeRichText } from "@/lib/content/inline"
...
function renderSpan(span: InlineSpan, index: number) {
  ...
  if (marks.includes("code")) {
    element = (
      <code className="bg-muted rounded px-1 py-0.5 font-mono text-[0.85em]" key={index}>
        {element}
      </code>
    )
  }
