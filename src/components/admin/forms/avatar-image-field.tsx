...
import {
  ...
  AvatarPreview,
} from "@/components/admin/forms/avatar-crop-modal"
import { buttonVariants } from "@/components/ui/button"
import { updateAboutAvatar, updateOwnerAvatar } from "@/lib/admin/actions/settings"
import { uploadProfileAvatar } from "@/lib/admin/actions/uploads"
import {
  ...
  async function handleSave(transform: AvatarCropTransform) {
    ...
    try {
      ...
      if (result?.success) {
        ...
        if (!persist?.success) {
          setUploadError(persist?.error ?? "Photo uploaded but could not save to settings.")
