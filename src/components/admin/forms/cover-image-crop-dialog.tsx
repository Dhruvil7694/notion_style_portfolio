...
export function CoverImageCropDialog({
  ...
  async function handleConfirm() {
    ...
    const activeCrop = completedCrop ?? (crop && image ? convertToPixelCrop(crop, image.width, image.height) : null)
    ...
    >
      ...
      >
        ...
        <div className="px-5 py-3">
          {cropError ? <p className="text-destructive text-sm">{cropError}</p> : null}
        </div>
