...
function AvatarCropFrame({
  ...
  const clamped = imageSize
    ? clampAvatarTransform(transform, imageSize.width, imageSize.height, frameSize)
    : transform
...
export function AvatarCropModal({
  ...
  const [transform, setTransform] = useState<AvatarCropTransform>(DEFAULT_AVATAR_TRANSFORM)

  const isAbout = variant === "about"
  const modalFrameSize = isAbout ? AVATAR_ABOUT_MODAL_FRAME_SIZE_PX : AVATAR_MODAL_FRAME_SIZE_PX
  const previewFrameSize = isAbout ? AVATAR_ABOUT_FRAME_SIZE_PX : AVATAR_FRAME_SIZE_PX
