...
import { ProjectsFilterSubmenu } from "@/components/public/projects-filter-submenu"
import {
    ...
    <div className="projects-filters">
      <div className="projects-filters-search-row">
        <label className="projects-filters-search" htmlFor={searchId}>
          <Search aria-hidden className="projects-filters-search-icon" size={16} strokeWidth={1.75} />
          <input
        ...
        <div className="projects-filters-menu-shell" ref={menuRef}>
          <button
            ...
            className={cn(
              ...
              (filtersOpen || activeCount > 0) && "projects-filters-menu-trigger-active"
            )}
            onClick={() => {
          ...
          >
            ...
            {activeCount > 0 ? (
              <span className="projects-filters-menu-trigger-badge">{activeCount}</span>
            ) : null}
          </button>
                  ...
                  return (
                    <button
                      className={cn(
                        ...
                        hoveredMenu === menuKey && "projects-filters-menu-item-active"
                      )}
                      key={menuKey}
                      onMouseEnter={() => {
                        clearSubmenuHideTimer()
                    ...
                    >
                      {menuKey === "category" ? (
                        <FolderOpen aria-hidden size={15} strokeWidth={1.75} />
                      ) : null}
                      {menuKey === "tech" ? (
                      ...
                      {active ? <span className="projects-filters-menu-item-dot" /> : null}
                      <ChevronRight
                        aria-hidden
                ...
                {hoveredMenu ? (
                    ...
                    <>
                      <button
                        className={cn(
                          ...
                          filters.category === null && "projects-filters-submenu-option-active"
                        )}
                  ...
                  {hoveredMenu === "status" ? (
                    <button
                      className={cn(
                        "projects-filters-submenu-option",
                        filters.featuredOnly && "projects-filters-submenu-option-active"
                      )}
                  ...
                  <div className="projects-filters-submenu-separator" role="separator" />
      ...
      <div className="projects-filters-meta">
        ...
        {hasActiveProjectFilters(filters) ? (
          <button className="projects-filters-clear" onClick={clearFilters} type="button">
            Clear filters
          </button>
        ) : null}
      </div>
