...
import { resolveAiFirstKeywordIcon } from "@/components/public/ai-first-keyword-icons"
import { caveatHandwriting } from "@/lib/fonts/caveat"
import type { AiFirstKeywordDetail } from "@/lib/public/ai-first-keyword-details"
...
function computePanelPosition(anchor: DOMRect): PanelPosition {
  ...
  return {
    left,
    top: Math.min(anchor.bottom + SECTION_GAP, viewportHeight - VIEWPORT_PADDING),
    width,
    placement: "below",
  }
}
    ...
    <div className="ai-first-keyword-preview-root">
      <div
        className={cn(
          ...
          glassPanelClass,
          position.placement === "above" && "ai-first-keyword-preview-card-above",
          position.placement === "below" && "ai-first-keyword-preview-card-below",
          visible && "is-visible"
        )}
        id={previewId}
