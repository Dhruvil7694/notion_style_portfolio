...
interface AnimatedThemeTogglerProps extends React.ComponentPropsWithoutRef<"button"> {
   ...
   * (e.g. site theme provider) and this component will not write to localStorage.
   */
  theme?: "light" | "dark"
  /** Called on toggle. Pair with `theme` for controlled usage. */
  onThemeChange?: (theme: "light" | "dark") => void
  /** Optional label rendered beside the icon (e.g. dock expand label). */
...
export const AnimatedThemeToggler = ({
  ...
  useEffect(() => {
    ...
    const updateTheme = () => {
      ...
      if (siteTheme === "light" || siteTheme === "dark") {
        setInternalIsDark(siteTheme === "dark")
        return
      }
  ...
  return (
    <button
      ...
      {...props}
    >
      <span className={cn(label ? "dock-item-icon" : undefined)}>
        {isDark ? <Sun /> : <Moon />}
      </span>
      {label ? <span className="dock-item-label">{label}</span> : null}
