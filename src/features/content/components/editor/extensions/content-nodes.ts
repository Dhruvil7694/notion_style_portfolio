...
import { ContentNodeViews } from "@/features/content/components/editor/node-views/content-node-views"
...
export const GlossaryTermNode = Node.create({
  ...
  renderHTML({ HTMLAttributes }) {
    return [
      "div",
      mergeAttributes({ "data-type": "glossary-term" }, HTMLAttributes),
    ]
  },
  addNodeView() {
...
export const ProjectReferenceNode = Node.create({
  ...
  renderHTML({ HTMLAttributes }) {
    return [
      "div",
      mergeAttributes({ "data-type": "project-reference" }, HTMLAttributes),
    ]
  },
  addNodeView() {
...
export const ArchitectureDiagramNode = Node.create({
  ...
  renderHTML({ HTMLAttributes }) {
    return [
      "div",
      mergeAttributes({ "data-type": "architecture-diagram" }, HTMLAttributes),
    ]
  },
  addNodeView() {
...
export const ExpandableSectionNode = Node.create({
  ...
  renderHTML({ HTMLAttributes }) {
    return [
      "div",
      mergeAttributes({ "data-type": "expandable-section" }, HTMLAttributes),
    ]
  },
  addNodeView() {
