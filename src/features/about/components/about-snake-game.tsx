...
import {
  ...
  stepGame,
  tickMsForScore,
} from "@/features/about/lib/snake-game/engine"
import {
  getDefaultLevelId,
  getSnakeLevel,
  SNAKE_LEVELS,
} from "@/features/about/lib/snake-game/levels"
import { getSnakePalette } from "@/features/about/lib/snake-game/palette"
import {
  getPersonalBest,
  getWinner,
  loadPlayerProfile,
  ...
  savePlayerProfile,
  saveScoreEntry,
} from "@/features/about/lib/snake-game/scoreboard"
import type {
  GameState,
  ScoreEntry,
  SnakeLevelId,
} from "@/features/about/lib/snake-game/types"
