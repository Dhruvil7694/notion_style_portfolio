...
export async function updateOwnerAvatar(
  url: string | null
...
export async function updateAboutAvatar(
  url: string | null
): Promise<ActionResult> {
  const parsed = urlSchema.safeParse(url)
  ...
  const updates = [
    {
      key: "site_settings",
      value: {
        ...(typeof existingByKey.site_settings === "object" &&
    ...
    },
    {
      key: "social_links",
      value: {
        ...(typeof existingByKey.social_links === "object" &&
    ...
    },
    {
      key: "contact_info",
      value: {
        ...(typeof existingByKey.contact_info === "object" &&
