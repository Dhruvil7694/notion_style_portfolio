  ...
  return (
    <div className="space-y-5">
      <p className="text-muted-foreground text-sm leading-relaxed">
        Images appear inside the case study narrative — not as a separate
        gallery page. Use types to control placement: screenshots under Problem,
        walkthrough types in the carousel, demos near Results.
      </p>
        ...
        >
          ...
          {item.url.trim() ? (
            <div className="relative aspect-video overflow-hidden rounded-md border border-border bg-muted/20">
              <Image
                alt={
                  item.alt?.trim() || item.caption?.trim() || "Gallery preview"
                }
