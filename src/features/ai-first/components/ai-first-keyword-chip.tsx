...
import { AiFirstKeywordPreviewPanel } from "@/features/ai-first/components/ai-first-keyword-preview-panel"
import { getAiFirstKeywordDetail } from "@/features/portfolio/lib/ai-first-keyword-details"
...
export function AiFirstKeywordChip({
  label,
  className,
}: AiFirstKeywordChipProps) {
  ...
  return (
    <>
      <li
        ...
        className={cn(
          "ai-first-keyword ai-first-keyword-interactive",
