...
export const COPILOT_TOOLS: CopilotToolDefinition[] = [
  ...
  },
  {
    ...
    parameters: {
      entityType: {
        type: "string",
        description: "project or content",
        required: true,
      },
  ...
  },
  {
    ...
    parameters: {
      ...
      content: {
        type: "object",
        description: "FAQ items to apply",
        required: true,
      },
    },
  },
  ...
  },
  {
    ...
    parameters: {
      ...
      newContent: {
        type: "string",
        description:
          "Exact replacement text (optional if instruction provided)",
      },
      instruction: {
        type: "string",
        description:
