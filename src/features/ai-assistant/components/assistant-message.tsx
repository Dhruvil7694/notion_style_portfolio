...
import type { CitationBundle } from "@/features/ai/lib/citations/citation-types"
import type { EntityLink } from "@/features/ai-assistant/components/assistant-context"
import { JobFitSeniorityVerdict } from "@/features/job-fit/components/job-fit-seniority-hint"
import { JobFitSkillChartFromMarkdown } from "@/features/job-fit/components/job-fit-skill-chart"
...
const CONTACT_TRIGGER =
  /\bcontact\b|\breach out\b|\bemail\b|\bhire\b|\bget in touch\b|only here to answer questions about Dhruvil|not about Dhruvil|outside (my |the )?scope/i
