        ...
        {items.map((item) => (
          <li key={item.id}>
            ...
            >
              ...
              {item.description ? (
                <span className="discovery-explore-description">
                  {item.description}
                </span>
              ) : null}
            </Link>
    ...
    <div className="discovery-explore">
      ...
      {filtered ? (
        <section className="discovery-explore-section">
          ...
          {filtered.length === 0 ? (
            <p className="discovery-search-empty">
              ...
              {filtered.map((item) => (
                <li key={item.id}>
                  <Link
                    ...
                    href={toRelativePath(item.url)}
                  >
                    <span className="discovery-explore-meta">
                      {DISCOVERY_TYPE_LABELS[item.type]}
                    </span>
                    <span className="discovery-explore-title">
                      {item.title}
                    </span>
                  </Link>
                </li>
        ...
        <>
          <ExploreSection
            items={sections.popularTopics}
            sectionKey="popular-topics"
          ...
          />
          <ExploreSection
            items={sections.automations}
            sectionKey="automations"
            title="Automations"
          />
          <ExploreSection
            items={sections.expertise}
            sectionKey="expertise"
            title="Expertise"
          />
          <ExploreSection
            items={sections.technologies}
